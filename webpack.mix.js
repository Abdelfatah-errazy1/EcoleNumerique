...
mix.postCss('resources/mix/custom/plugins.bundle.rtl.css', 'public/assets/css/plugins.bundle.rtl.css');
mix.postCss('resources/mix/custom/style.bundle.rtl.css', 'public/assets/css/style.bundle.rtl.css');
...
(glob.sync(`resources/mix/custom/js/**/*.js`) || []).forEach(file => {

    var output = `public/assets/${file.replace(`resources/mix/custom/js`, 'js')}`;
    mix.scripts(file, output);
});

(glob.sync(`resources/mix/custom/css/**/*.css`) || []).forEach(file => {

    var output = `public/assets/${file.replace(`resources/mix/custom/css`, 'css')}`;
