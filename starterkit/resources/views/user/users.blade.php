...
<div class="col-xl-12">
    ...
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
                ...
                <span class="text-center h1">Liste Des Users</span>
                <div class="ms-auto">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                            ...
                            <a href="{{route('user.create')}}" class="dropdown-item"> <i class="las la-plus"></i> Ajouter nouveau</a>
                            <a href="{{route('users.delete')}}" class="dropdown-item"> <i class="las la-trash-alt"></i> Supprimer La Selection</a>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="table">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            ...
                            <th class="min-w-120px"> codepostal </th>
                            <th class="min-w-120px"> email </th>
                            <th class="min-w-120px"> website </th>
                            <th class="min-w-120px"> tel </th>
                            <th class="min-w-120px"> cin </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['nom'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['prenom'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['ville'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['codepostal'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['webSite'] }}</span>
                                    </div>
                                </div>
                            </td>
                             ...
                             <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['tel'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                        <span class="text-dark fw-bolder text-hover-primary fs-6">{{ $user['cin'] }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    <a href=" {{ route('user.show' , ['id' => $user['id']]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    ...
                                    <a href=" {{ route('user.delete' , ['id' => $user['id']]) }}" class="btn btn-icon delete-record btn-bg-light btn-active-color-primary btn-sm me-1">
...
<script>
        ...
        $('a[href="{{ route('users.delete') }}"]').on('click', function (e) {
                    ...
                    window.href = "{{ route('users.delete') }}";
