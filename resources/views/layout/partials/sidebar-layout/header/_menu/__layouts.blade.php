		...
		<div class="col-lg-6">
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-3">
					<!--begin:Heading-->
					<h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">{{ trans('menu.tables') }}</h4>
					<!--end:Heading-->
					<!--begin:Menu item-->
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route('admin.secteurs.index') }}" class="menu-link">
							<span class="menu-bullet">
								<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
							</span>
							<span class="menu-title">{{ trans(ucwords('app.secteurs')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="{{ route('admin.options.index') }}" class="menu-link">
							...
							<span class="menu-title">{{ trans(ucwords('app.options ')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							...
							<span class="menu-title">{{ trans('app.') }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route('admin.etablissements.index') }}" class="menu-link">
							<span class="menu-bullet">
								<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
							</span>
							<span class="menu-title">{{ trans(ucwords('etablissements')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route('admin.centresFormations.index') }}" class="menu-link">
							<span class="menu-bullet">
								<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
							</span>
							<span class="menu-title">{{ trans(ucwords('centresFormations')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route('admin.directeur.index') }}" class="menu-link">
							<span class="menu-bullet">
								<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
							</span>
							<span class="menu-title">{{ trans(ucwords('directeur')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route('admin.abonnements.index') }}" class="menu-link">
							<span class="menu-bullet">
								<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
							</span>
							<span class="menu-title">{{ trans(ucwords('abonnements')) }}</span>
						</a>
						<!--end:Menu link-->
					</div>
					<!--end:Menu item-->
