...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="/">
		...
		@if ($bodyAttribute === 'dark-sidebar')
			<img alt="Logo" src="{{ asset('assets/imgs/logoMr.png') }}" style="height: 115px !important; width: 176px;"  class="h-25px app-sidebar-logo-default" />
        @elseif($bodyAttribute === 'light-sidebar')
				<img alt="Logo" src="{{asset('assets/imgs/logoMr.png') }}" style="height: 115px !important; width: 176px;"  class="theme-light-show h-25px app-sidebar-logo-default" />
				<img alt="Logo" src="{{ image('logos/default-dark.svg') }}" class="theme-dark-show h-25px app-sidebar-logo-default" />
		@endif

		<img alt="Logo" src="{{ asset('assets/imgs/logoMr.png')}}"  style="height: 115px !important; width: 176px;" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
