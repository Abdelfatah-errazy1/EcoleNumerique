            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_new_password_form" method="post" action="{{ route('admin.resetPassword.change') }}">
                            @csrf
                            <div class="text-center mb-10">
                                ...
                                <div class="text-gray-500 fw-semibold fs-6"> {{ trans("auth.register_login") }}?
                                    <a href="{{ route('admin.login.view') }}" class="link-primary fw-bold">{{ trans('auth.login_to_account') }}</a></div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group-->
