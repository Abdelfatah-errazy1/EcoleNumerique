...
@section('page_title' , trans('pages/admin/profile.page_title'))
@section('content')
            ...
            <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                ...
                <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                    ...
                    <form class="form w-100" novalidate="novalidate" method="post"
                          action="{{ route('admin.login.check') }}" id="kt_sign_in_form">
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Email-->
                            <input type="text" placeholder="{{ trans('auth.email') }}" name="email" autocomplete="off"
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                            ...
                            <a href="{{ route('admin.forgotPassword.view') }}"
