...
@section('page_title' , trans('pages/admin/secteurs.edit_page_title'))
@section('breadcrumb')
    <x-group.bread-crumb
        ...
        ['name'=> trans('pages/admin/secteurs.edit_page_title') ,     'current' =>true ],
    ]"
    />
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <x-form.form
                method="post"
                action="{{ route('admin.secteurs.update' , $model[$model::PK]) }}"
            >
                <x-form.card col="col-12 row" title="{{ ucwords(trans('pages/admin/secteurs.edit_page_title')) }}">
...
{{--            <x-form.card col="col-12 row " title="{{ ucwords(trans('pages/secteurs.edit_page_dt_options_title')) }}">--}}
{{--                @bind( $model->options )--}}
{{--                <x-table.data-table--}}
{{--                    :actions="$actions"--}}
{{--                    :heads="$heads"--}}
