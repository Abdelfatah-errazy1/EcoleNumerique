                    ...
                    <li class="nav-item ms-auto">
                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">  {{ ucwords(trans('app.actions')) }}</div>
                            </div>
                                            ...
                                            @case(\App\Helpers\Components\Head::TYPE_IMG)
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-3">
                                                        <x-media.image
                                                            :alt="$model->getRawOriginal($head->getName()) ?? '' "
                                                            :src="$image($model->getRawOriginal($head->getName()))"/>
...
@push('scripts')
    <script>
        ...
        var dataTable = window.mrx.tools.generateDataTable('#{{ $id() }}')
        ...
        $('.delete-record').on('click', function (e) {
            ...
            Swal.fire({
                ...
                confirmButtonText: '{{ trans('app.delete') }}'
            })
